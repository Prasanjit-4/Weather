...
tree = ttk.Treeview(TableMargin, columns=("Formatted","Summary","Precip","Temperature","AppHum","Humidity","Windsp","Wind Bearing","Cloud Cover","Pressure","Daily Summary"), height=400, selectmode="extended", yscrollcommand=scrollbary.set, xscrollcommand=scrollbarx.set)
